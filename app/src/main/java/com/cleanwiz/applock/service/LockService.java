...
//						}
						...
						packageName = ForegroundDetectionService.packageName;
					} else {
					...
					if (lockState && !inWhiteList(packageName)
							&& !packageName.equals(lastLoadPackageName)) {
						lastLoadPackageName = packageName;
